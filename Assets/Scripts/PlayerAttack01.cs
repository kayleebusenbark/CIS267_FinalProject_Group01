...
public class PlayerAttack01 : MonoBehaviour
{
    ...
    {
        if(collision.CompareTag("SkeletonEnemy") || collision.CompareTag("WolfEnemy") || collision.CompareTag("Wizard") || collision.CompareTag("BushMonster") || collision.CompareTag("FlowerEnemy") || collision.CompareTag("Cyclops") || collision.CompareTag("Orc") || collision.CompareTag("BatEnemy") || collision.CompareTag("SpiderEnemy"))
        {
